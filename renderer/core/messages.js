...
import { createMessageAttachmentIndicator } from '../components/message-attachment-indicator.js';
...
export async function sendMessage() {
    ...
    if (attachedFiles && attachedFiles.length > 0) {
        ...
        if (contentDiv) {
            const attachmentIndicator = createMessageAttachmentIndicator(attachedFiles);
